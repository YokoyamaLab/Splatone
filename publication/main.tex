...
%--------- Meta data ----------
\title{Splatone crawler: ジオソーシャルデータの収集・可視化ツール}
...
Visualizerは可視化手法をパッケージ化したものであり、これも第三者が任意の可視化手法を追加する事が可能である。
...
Visualizerはクローリングしたジオタグ付きデータを地図上に描画するための機能であり、これもオープンアーキテクチャであり、サードパーティによる追加が可能である。現在は以下の可視化手法を実装している。
...
\begin{figure}[h]
  \begin{center}
  \includegraphics[width=100mm]{figures/result_venezia_bulky.png}
