...
% The first real \section in main-jlreq.tex starts the manuscript body. The
% legacy bibliography is discarded and replaced below by elsarticle-num.
% ---------------------------------------------------------------------------
\CatchFileDef{\LegacyManuscript}{main-jlreq.tex}{}
\long\def\UseLegacyManuscriptBody#1\section#2\bibliographystyle#3\SoftwareXEnd{\section#2}
\expandafter\UseLegacyManuscriptBody\LegacyManuscript\SoftwareXEnd
